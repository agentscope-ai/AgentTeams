...
.PHONY: all build build-openclaw-base build-agentteams-controller build-embedded build-manager build-manager-copaw build-worker build-copaw-worker build-hermes-worker build-deepagents-worker build-deepagents-runner build-openhuman-worker \
        build-qwenpaw-worker \
        tag push push-openclaw-base push-agentteams-controller push-embedded push-manager push-manager-copaw push-worker push-copaw-worker push-hermes-worker push-deepagents-worker push-deepagents-runner push-openhuman-worker \
        push-qwenpaw-worker \
        push-native push-native-manager push-native-manager-copaw push-native-worker push-native-copaw-worker push-native-hermes-worker push-native-deepagents-worker push-native-deepagents-runner push-native-openhuman-worker \
...
build: build-manager build-manager-copaw build-worker build-copaw-worker build-hermes-worker build-deepagents-worker build-deepagents-runner build-openhuman-worker build-qwenpaw-worker build-agentteams-controller ## Build all images (base image pulled from registry, not rebuilt locally)
