...
- Check whether the task has made file-level progress since the last heartbeat:
  ```bash
  bash /opt/hiclaw/agent/skills/task-management/scripts/check-progress-watchdog.sh \
    --task-id {task-id}
  ```
