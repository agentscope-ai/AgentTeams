...
resolve_image_tags() {
    ...
    COPAW_WORKER_IMAGE="${AGENTTEAMS_INSTALL_COPAW_WORKER_IMAGE:-${AGENTTEAMS_REGISTRY}/${_image_org}/${_image_org}-copaw-worker:${AGENTTEAMS_VERSION}}"
    HERMES_WORKER_IMAGE="${AGENTTEAMS_INSTALL_HERMES_WORKER_IMAGE:-${AGENTTEAMS_REGISTRY}/${_image_org}/${_image_org}-hermes-worker:${AGENTTEAMS_VERSION}}"
    EMBEDDED_IMAGE="${AGENTTEAMS_INSTALL_EMBEDDED_IMAGE:-${AGENTTEAMS_REGISTRY}/${_image_org}/${_image_org}-embedded:${AGENTTEAMS_VERSION}}"
