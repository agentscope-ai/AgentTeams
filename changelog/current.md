...
- **CoPaw worker skill projection**: CoPaw workers now refresh the runtime workspace skill projection and manifest whenever Manager-pushed skills change, so newly applied skills become visible without a worker restart.
