...
CREDEOF
    ...
    if [ "${AGENTTEAMS_USE_EMBEDDED}" = "1" ]; then
        ...
        local _ctrl_env_args=(
            ...
            -e "${_ctrl_env_prefix}MODEL_CONTEXT_WINDOW=${AGENTTEAMS_MODEL_CONTEXT_WINDOW:-}"
            -e "${_ctrl_env_prefix}MODEL_MAX_TOKENS=${AGENTTEAMS_MODEL_MAX_TOKENS:-}"
            -e "${_ctrl_env_prefix}MODEL_REASONING=${AGENTTEAMS_MODEL_REASONING:-}"
            -e "${_ctrl_env_prefix}MODEL_VISION=${AGENTTEAMS_MODEL_VISION:-}"
