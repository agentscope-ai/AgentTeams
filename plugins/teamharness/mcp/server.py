        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "sender": {
                    "type": "object",
                    "description": (
                        "Source agent/session for same-agent self-trigger "
                        "handoff, for example a DingTalk group, Matrix DM, or "
                        "Matrix room session. Required for PROJECT_REQUESTED "
                        "trigger routing."
                    ),
                    "additionalProperties": True,
                    "properties": {
                ...
                "agentId": {
                    "type": "string",
                    "description": "Acting TeamHarness/QwenPaw agent id; used to confirm same-agent trigger routing.",
                },
                "type": {
                    "type": "string",
