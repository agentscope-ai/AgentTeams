...
function Install-Manager {
    ...
    if ($script:AGENTTEAMS_USE_EMBEDDED -eq "1") {
        ...
        $ctrlArgs = @(
            ...
            "-e", "AGENTTEAMS_MODEL_CONTEXT_WINDOW=$($config.MODEL_CONTEXT_WINDOW)",
            "-e", "AGENTTEAMS_MODEL_MAX_TOKENS=$($config.MODEL_MAX_TOKENS)",
            "-e", "AGENTTEAMS_MODEL_REASONING=$($config.MODEL_REASONING)",
            "-e", "AGENTTEAMS_MODEL_VISION=$($config.MODEL_VISION)",
