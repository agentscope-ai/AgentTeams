...
- fix(controller): pass sandbox Worker runtime env/auth material into SandboxClaim deps and block legacy pod-to-sandbox runtime switches until the Worker is stopped.
