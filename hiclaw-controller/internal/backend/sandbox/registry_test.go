...
func (s *stubPlugin) CreateSandbox(_ context.Context, _ SandboxSpec, _ ProviderConfig) (SandboxHandle, error) {
	return SandboxHandle{}, nil
}
func (s *stubPlugin) DeleteSandbox(_ context.Context, _ string, _ ProviderConfig) error { return nil }
...
func (s *stubPlugin) GetStatus(_ context.Context, _ string, _ ProviderConfig) (SandboxStatus, error) {
