...
- **Installer image path compatibility**: Enforce `agentteams/agentteams-*` image naming for v1.1.2+; reject older versions with an actionable `hiclaw-install.sh` message. Fixes #1071.
