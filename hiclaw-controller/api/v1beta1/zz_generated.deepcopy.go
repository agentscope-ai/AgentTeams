...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TeamAccessPolicySpec) DeepCopyInto(out *TeamAccessPolicySpec) {
	*out = *in
	if in.DefaultEntries != nil {
		in, out := &in.DefaultEntries, &out.DefaultEntries
		*out = make([]AccessEntry, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TeamAccessPolicySpec.
func (in *TeamAccessPolicySpec) DeepCopy() *TeamAccessPolicySpec {
	if in == nil {
		return nil
	}
	out := new(TeamAccessPolicySpec)
	in.DeepCopyInto(out)
	return out
}
