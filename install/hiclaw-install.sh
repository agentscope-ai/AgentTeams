...
CREDEOF
    ...
    if [ "${AGENTTEAMS_USE_EMBEDDED}" = "1" ]; then
        ...
        local _ctrl_env_args=(
            ...
            -e "AGENTTEAMS_MODEL_CONTEXT_WINDOW=${AGENTTEAMS_MODEL_CONTEXT_WINDOW:-}"
            -e "AGENTTEAMS_MODEL_MAX_TOKENS=${AGENTTEAMS_MODEL_MAX_TOKENS:-}"
            -e "AGENTTEAMS_MODEL_REASONING=${AGENTTEAMS_MODEL_REASONING:-}"
            -e "AGENTTEAMS_MODEL_VISION=${AGENTTEAMS_MODEL_VISION:-}"
